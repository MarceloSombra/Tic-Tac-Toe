...
def jogadaMaquina(tabuleiro, jogada):
    ...
    if jogada == 3:
        if tabuleiro["B"][0] == "O" and tabuleiro["C"][1] == "O":
            tabuleiro["B"][1] = "X"
        elif tabuleiro["C"][2] == "X" and tabuleiro["B"][1] == "":
            tabuleiro["B"][1] = "X"
        elif tabuleiro["B"].count("O") == 2 and tabuleiro["B"][0] == "":
            tabuleiro["B"][0] = "X"
        elif tabuleiro["B"][0] == "" and tabuleiro["C"][0] == "X":
            tabuleiro["B"][0] = "X"
        elif tabuleiro["B"].count("O") == 2 and tabuleiro["B"][1] == "":
            tabuleiro["B"][1] = "X"
        elif tabuleiro["B"].count("O") == 2 and tabuleiro["B"][2] == "":
            tabuleiro["B"][2] = "X"
        elif tabuleiro["A"][1] == "O" and tabuleiro["B"][1] == "O":
            tabuleiro["C"][1] = "X"
        elif tabuleiro["C"][0] == "X" and tabuleiro["C"][2] == "":
            tabuleiro["C"][2] = "X"
        elif tabuleiro["C"][2] == "X":
            tabuleiro["A"][2] = "X"
        elif tabuleiro["A"][2] == "":
            tabuleiro["A"][2] = "X"

    if jogada == 4:
        if tabuleiro["C"][2] == "X" and tabuleiro["B"][1] == "":
            tabuleiro["B"][1] = "X"
        elif tabuleiro["C"][0] == "X" and tabuleiro["C"][2] == "X":
            if tabuleiro["C"][1] == "":
                tabuleiro["C"][1] = "X"
        elif tabuleiro["B"][1] == "X" and tabuleiro["C"][2] == "":
            tabuleiro["C"][2] = "X"
        elif tabuleiro["B"][1] == "X" and tabuleiro["A"][2] == "":
            tabuleiro["A"][2] = "X"    
        elif tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "":
            tabuleiro["A"][1] = "X" 
        elif tabuleiro["C"][0] == "X" and tabuleiro["A"][2] == "X":
            if tabuleiro["B"][1] == "":
                tabuleiro["B"][1] = "X"  
        elif tabuleiro["A"][2] == "X" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][2] == "":
                tabuleiro["B"][2] = "X"
        elif tabuleiro["A"][1] == "O" and tabuleiro["B"][1] == "O":
            tabuleiro["C"][1] = "X" 
